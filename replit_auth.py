...
def save_user(user_claims):
    ...
    user.full_name = f"{user.first_name or ''} {user.last_name or ''}".strip() or user.email
    user.username = user.email or user.id
    user.role = user.role or UserRole.WAITER  # Default role for new users
    user.is_active = True
